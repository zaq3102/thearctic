        ...
        <div className="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
          <div className="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
            ...
            <div className="block py-1 pr-1 pl-1 ">
              <Link
                to="game"
                className="my-6 py-4 px-8 hover:scale-105 duration-300 ease-in-out inline-block text-m rounded-full text-white bg-blue-800 mt-4 lg:mt-0"
              >
                게임 플레이
              </Link>
            </div>
          ...
          <div className="w-full md:w-3/5 py-6 text-center">
            <img className="w-full md:w-3/5 z-50 ml-10" src={SadPolarBear} />
          </div>
        </div>
      </div>
    </div>
