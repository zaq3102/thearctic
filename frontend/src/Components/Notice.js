...
export default function Notice(props) {
  ...
  return (
    <div className="notice">
      <h1 className="mb-4 text-4xl font-extrabold tracking-tight leading-none text-gray-900 md:text-5xl lg:text-6xl dark:text-white text-center">공지사항</h1>
      ...
      <div className="notice-content">
        <p className="mb-6 text-lg font-normal text-black-500 lg:text-xl sm:px-16 xl:px-48 dark:text-black-400">새로운 기능 및 버그 수정 내용이 업로드될 예정입니다.</p>
        <div className="version sm:px-16 xl:px-48">
          <p className="mb-6 text-base font-normal text-black-500 lg:text-base dark:text-black-400">버전 0.1.0</p>
